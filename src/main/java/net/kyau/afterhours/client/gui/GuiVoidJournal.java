  ...
  public void drawScreen(int mouseX, int mouseY, float renderPartials) {
    ...
    switch (pageIndex) {
      ...
      case 1:
        ...
        RenderUtils.renderSplitText("  \u00A771\u00A70..... \u00A7fCover\n  \u00A772\u00A70..... \u00A7fTable of Contents\n\n  \u00A773\u00A70..... \u00A7fThere's No Place Like Home\n  \u00A774\u00A70..... \u00A7fQuantum Imprinting & Void Energy\n  \u00A775\u00A70..... \u00A7fVoidstone\n  \u00A776\u00A70..... \u00A7fThe Singularity\n  \u00A777\u00A70..... \u00A7fEnter the Void\n  \u00A778\u00A70..... \u00A7fDark Matter\n  \u00A779\u00A70..... \u00A7fQuantum Components\n  \u00A7710\u00A70.. \u00A7fQuantum Components (cont.)\n  \u00A7711\u00A70.. \u00A7fQuantum Devices\n\n\n\u00A78To navigate the guide use the buttons at the bottom of the screen, the mouse wheel, or typing in the page number works (up to page nine).", bookXStart + 70, guiHeight + 48, 240, 0xffffff, 0);
        super.drawScreen(mouseX, mouseY, renderPartials);
        break;
      case 2:
        renderBook(bookXStart, book_recipes, "There's No Place Like Home");
        // text
        RenderUtils.renderSplitText("\u00A7n\u00A7fVoid Crystal\n\n\u00A7r\u00A77  Because jumping straight into \u00A7fThe Void\u00A77 would generally be a bad idea, you should first start by educating yourself on the basics of \u00A7aVoid Energy\u00A77 manipulation. The first ingredient you will need is the \u00A7fVoid Crystal\u00A77, these are used as a storage medium for \u00A7aVoid Energy\u00A77 and will eventually be used as a power source for your quantum machinery.\n\n\u00A7fVoid Pearl\u00A77\n\n  Before you can begin your progress into \u00A7aVoid Energy\u00A77 you must be certain that if anything goes wrong you always have a way back home. The \u00A7eVoid Pearl\u00A77 will provide you with this, on use you will be transported via latent \u00A7aVoid Energy\u00A77 in the environment to your position of origin. The \u00A7fVoid Crystal\u00A77 inside this device will require a recharge time of \u00A7f" + ItemHelper.formatCooldown(Ref.ItemCooldown.VOIDPEARL / 20) + "\u00A77 before it can be used again.", bookXStart + 16, guiHeight + 40, 240, 0xffffff, 0);
        // recipe #1
        ...
        break;
      case 3:
        renderBook(bookXStart, book_page3, "Quantum Imprinting & Void Energy");
        RenderUtils.renderSplitText("\u00A7fQuantum Imprinting\u00A77\n\n  At this point you should begin to notice that items involving \u00A7aVoid Energy\u00A77 will gain a quantum imprint of the user on first use. While this is needed for stabilization of the device, it also restricts access to the device via quantum imprint (ie. if you don't own it you can't use it).\n\n\u00A7fVoid Energy\u00A77\n\n  Despite the \u00A7fVoid Pearl\u00A77 not storing energy, it is the first device to harness it. \u00A7aVoid Energy\u00A77, or what once was called Dark Energy, is the energy that powers the chunk-verse. It is the force that naturally expands and grows the chunk-verse itself. Given the extremely high levels of energy and unstable nature of \u00A7aVoid Energy\u00A77 it can not be harnessed as a fuel source by conventional means. Devices that do store \u00A7eVoid Energy\u00A77 can be replenished close to \u00A7fThe Void\u00A77, within 10 blocks of bedrock in the Overworld, or you can visit \u00A7fThe Void\u00A77 where your devices will naturally regenerate.", bookXStart + 16, guiHeight + 34, 240, 0xffffff, 0);
        super.drawScreen(mouseX, mouseY, renderPartials);
        break;
      case 4:
        renderBook(bookXStart, book_furnace_recipe, "Voidstone");
        RenderUtils.renderSplitText("  \u00A77While \u00A7fVoidstone\u00A77 and \u00A7eInfused Voidstone\u00A77 can be used for building, both being extremely damage resistant and one giving off a modest amount of light, they are infact stabilization agents for manipulating \u00A7aVoid Energy\u00A77.\n\n\u00A7fVoidstone\u00A77\n\n  As the basic building block of all things related to \u00A7fThe Void\u00A77 this block will be key to you gaining access to and progressing further. Requiring a \u00A7bDiamond\u00A77 level tool to harvest it provides a blast resistace that is five times that of obsidian.\n\n\u00A7eInfused Voidstone\u00A77\n\n  By infusing \u00A7fVoidstone\u00A77 with a \u00A7fVoid Crystal\u00A77 and glowstone you will modify it's properties, removing the unstable nature and allowing it to become a conduit for \u00A7aVoid Energy\u00A77. This will in turn cause the block to give off a glow almost equivalent to glowstone itself.", bookXStart + 16, guiHeight + 37, 240, 0xffffff, 0);
        // furnace
      ...
      case 9:
        ...
        RenderUtils.renderSplitText("\u00A7bStable Core\u00A77\n\n  The last component you will need in the higher tier crafting recipes is the \u00A7bStable Core\u00A77 which is an \u00A7eUnstable Core\u00A77 that has been tamed by \u00A7bDark Matter\u00A77. This device will allow devices and gear to permanently store \u00A7aVoid Energy\u00A77 inside the core. Stored inside the core it will be contained enough to not harm the player. For more information on \u00A7aVoid Energy\u00A77 and how to replenish it, please refer to page 3 of this guide.", bookXStart + 16, guiHeight + 36, 240, 0xffffff, 0);
        // recipe #1
      ...
      case 10:
        ...
        RenderUtils.renderSplitText("\u00A7bQuantum Resonance Device\u00A77\n\n  \u00A77The \u00A7bQRD\u00A77 utilizes quantum resonance in order to harness the internal \u00A7aVoid Energy\u00A77 inside the \u00A7bStable Core\u00A77 to shift matter into qubits in order to be digitially stored in your personal SVCN (Subspace Void Communications Network) storage container. Items stored here will be accessible from anywhere provided you have your \u00A7bQRD\u00A77 with you. This device can access your Ender inventory by shift-right clicking. Inside you will also find slots for your other quantum devices and a Void slot.\n\n\u00A7bWormhole Manipulator\u00A77\n\n This device, similar to the \u00A7bQRD\u00A77 utilizes an internal core to manipulate subspace itself and open a wormhole suitable for instant matter transportation. In short you will be instantly transported to what you are looking at. Due to the massive amount of \u00A7aVoid Energy\u00A77 required to accomplish this you are required to charge this device before use.", bookXStart + 16, guiHeight + 36, 240, 0xffffff, 0);
        // recipe #1
