...
public class QuantumStabilizer extends BlockContainer {
  ...
  public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumFacing side, float var7, float var8, float var9) {
    ...
    if (player.isSneaking()) {
      ...
      if (world.getTileEntity(pos) instanceof TileEntityQuantumStabilizer)
        player.openGui(AfterHours.instance, AfterHours.GUI_QS, world, pos.getX(), pos.getY(), pos.getZ());
    }
  ...
  public void breakBlock(World world, BlockPos blockPos, IBlockState blockState) {
    TileEntityQuantumStabilizer tileStabilizer = (TileEntityQuantumStabilizer) world.getTileEntity(blockPos);
    if (tileStabilizer != null)
      tileStabilizer.dropItems();
  ...
  public TileEntity createNewTileEntity(World worldIn, int meta) {
    ...
    return new TileEntityQuantumStabilizer();
  }
